...
===== 실패
.request
include::{snippets}/search-username-not-found-member-fail/http-request.adoc[]

.response - 회원을 찾을 수 없음
include::{snippets}/search-username-not-found-member-fail/http-response.adoc[]

.response - 전화번호 불일치
include::{snippets}/search-username-not-equal-phone-fail/http-response.adoc[]
